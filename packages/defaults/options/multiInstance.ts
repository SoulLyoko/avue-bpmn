...
export const multiInstanceTypeColumn: BpmnFormColumnItem = {
  label: "多实例类型",
...
export const completionConditionColumn: BpmnFormColumnItem = {
  label: "完成条件",
...
export const collectionColumn: BpmnFormColumnItem = {
  label: "集合",
  prop: "collection",
  value: "",
...
export const elementVariableColumn: BpmnFormColumnItem = {
  label: "元素变量",
