...
declare module "diagram-js/lib/model" {
  import { BpmnBaseElement } from "bpmn-js";
...
declare module "diagram-js/lib/core/ElementRegistry" {
  ...
  export default class ElementRegistry {
    ...
    /**
     * Return element that match a given find function.
     */
    find(fn: (element: Base, gfx: SVGElement) => boolean): Base;
...
declare module "diagram-js/lib/core/Canvas" {
  ...
  export default class Canvas {
    ...
    resized(): void;
    zoom(newScale?: string | number, center?: Point | boolean): number;
    getDefaultLayer(): SVGElement;
    getLayer(name: string, index?: number): SVGElement;
    viewbox(position?: { x: number; y: number; width: number; height: number }): {
