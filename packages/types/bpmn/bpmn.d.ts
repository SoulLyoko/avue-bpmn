...
declare module "bpmn-js" {
  ...
  export default class Viewer extends Diagram {
     ...
     */
    importXML(xml: string, bpmnDiagram: BpmnDiDiagram | string, done?: DoneCallback): void;
    ...
    saveXML(options?: WriterOptions): Promise<{ xml: string }>;
  ...
  export type ElementEvent =
    ...
    | "element.mousedown"
    | "element.mouseup";
  export type SelectionEvent = "selection.changed" | "commandStack.changed";
  export type Event = GenericEvent | DiagramEvent | ElementEvent | ImportEvent | SaveEvent | SvgEvent | SelectionEvent;
