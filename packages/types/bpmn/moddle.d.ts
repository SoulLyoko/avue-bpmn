...
declare module "moddle/lib/moddle" {
  ...
  export default class Moddle {
    ...
    create<T extends BpmnElementType | string>(descriptor: T | Descriptor, attrs?: Attributes): BpmnElement<T>;

    getType<T extends BpmnElementType | string>(descriptor: T | Descriptor): ModdleElementCtor<T>;
  }
  ...
  export type BpmnElement<T extends string = ""> = BpmnElementMap extends Record<T, infer E> ? E : ModdleElement;

  export type ModdleElementCtor<T extends string> = new (attrs?: Attributes) => BpmnElement<T>;
