...
declare module "@smallwei/avue" {
  export interface TableColumn<T = any> extends FormColumn<T> {
    /** 是否搜索 */
    search?: boolean;
    /** 搜索表单的默认值 */
    ...
    searchFilterMethod?: (value: any, row: T, column: TableColumn<T>[]) => boolean;
    /** 表单新增时是否禁止 */
    addDisabled?: boolean;
    /** 表单新增时是否可见 */
    addDisplay?: boolean;
    ...
    /** TODO: 数据过滤使用的方法，如果是多选的筛选项，对每一条数据会执行多次，任意一次返回true就会显示 */
    filterMethod?: (value: any, row: T, column: TableColumn<T>[]) => boolean;
    /** 冻结列 */
    fixed?: boolean;
    /** 内容格式化 */
    formatter?: (row: T, value: any, label: string, column: TableColumn<T>[]) => string;
    /** 是否加入动态现隐列 */
    showColumn?: boolean;
    /** 开启排序 */
    sortable?: boolean;
  ...
  export interface TableOption<T = any> extends FormOption<T> {
    /** 表格头部表格 */
    title?: string;
    /** 添加按钮 */
    addBtn?: boolean;
  ...
  export type CellEvent = (row: any, column: TableColumn, cell: any, event: Event) => void;
  export type RowEvent = (row: any, column: TableColumn, event: Event) => void;
  export type AvueCrudDefaults = Record<string, TableColumn>;
  ...
  export interface AvueCrudProps<T = any> {
    ...
    permission?: TableOption<T> | ((key: string, row: T, index: number) => boolean);
    /** 表格搜索的表单的变量 v-model */
    search?: any;
    /** 配置项结构 */
    ...
    "upload-after"?: (res: any, done: () => void, loading: () => void, column: TableColumn<T>) => void;
    /** 删除文件之前的钩子，参数为上传的文件和文件列表，若返回 false 或者返回 Promise 且被 reject，则停止删除 */
    "upload-delete"?: (file: UploadFile, column: TableColumn<T>) => boolean | Promise<any> | void;
    /** 查看前的回调 */
    "upload-preview"?: (file: UploadFile, column: TableColumn<T>, done: () => void) => void;
    /** 上传失败错误回调 */
    "upload-error"?: (error: Error, column: TableColumn<T>) => void;
    /** 上传超过长度限制回调 */
    "upload-exceed"?: (limit: number, files: File[], fileList: UploadUserFile[], column: TableColumn<T>) => void;
    ...
    /** 当单元格hover进入时会触发该事件 */
    onCellMouseEnter?: CellEvent;
    /** 当单元格hover退出时会触发该事件 */
    onCellMouseLeave?: CellEvent;
    /** 当某个单元格被点击时会触发该事件 */
    onCellClick?: CellEvent;
    /** 当某个单元格被双击击时会触发该事件 */
    onCellDblclick?: CellEvent;
    /** 当某一行被点击时会触发该事件 */
    onRowClick?: RowEvent;
    /** 当某一行被双击时会触发该事件 */
    onRowDblclick?: RowEvent;
    /** 当表格的排序条件发生变化的时候会触发该事件 */
    onSortChange?: (args: { column: TableColumn; prop: string; order: "ascsending" | "descending" }) => any;
    /** 用于可展开表格与树形表格，切换某一行的展开状态，如果使用了第二个参数，则是设置这一行展开与否 */
    onToggleRowExpansion?: (row: T, expanded: boolean) => any;
    /** 更新搜索表单 */
  ...
  export type AvueCrudMethods<T = any> = {
    /** 重新初始化 */
    init: () => void;
    /** 重新初始化字典 */
    dicInit: () => void;
  ...
  export interface AvueCrudSlots<T = any> {
    ...
    [`${string}-header`]: (arg: { column: TableColumn<T> }) => VNode[];
    [`${string}-form`]: (arg: {
      value: any;
      column: TableColumn<T>;
      label: string;
  ...
  // export const AvueCrud: import("vue").DefineComponent<AvueCrudProps<any>, {}, {}, {}, AvueCrudMethods<any>>;
}
