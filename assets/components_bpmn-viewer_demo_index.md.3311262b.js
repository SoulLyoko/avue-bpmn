import{d as r,o,c,u,a as k,b as m,h as d,j as n,e,w as b,k as p,f as t}from"./app.4c23674a.js";var y=`<?xml version="1.0" encoding="UTF-8"?>
    ...
    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_mjMDg59">
      ...
      <bpmndi:BPMNEdge id="Flow_12b1u3b_di" bpmnElement="Flow_12b1u3b">
        ...
        <di:waypoint x="732" y="99" />
            ...
            <div>\u610F\u89C1: \u9000\u56DE</div>
          </div>`,position:{offsetX:-10,offsetY:80}}}];return(i,a)=>(o(),c(k("BpmnViewer"),{xml:u(y),data:s,style:{height:"400px"}},null,8,["xml"]))}}),h=p('<h1 id="bpmnviewer" tabindex="-1">BpmnViewer <a class="header-anchor" href="#bpmnviewer" aria-hidden="true">#</a></h1><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>\u793A\u4F8B\u4EE3\u7801\u7531\u4E8E\u6587\u6863 ssr \u7684\u95EE\u9898,\u5BFC\u81F4\u7EC4\u4EF6\u7684\u5199\u6CD5\u6709\u4E9B\u5947\u602A,\u4F7F\u7528\u65F6\u6309\u7167\u6B63\u5E38\u7684\u5199\u6CD5(\u6CE8\u91CA\u7684\u4EE3\u7801)\u5373\u53EF.</p></div><h2 id="basic" tabindex="-1">Basic <a class="header-anchor" href="#basic" aria-hidden="true">#</a></h2>',3),w=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
`)])])],-1),v=p(`<h2 id="props" tabindex="-1">Props <a class="header-anchor" href="#props" aria-hidden="true">#</a></h2><table><thead><tr><th>\u5C5E\u6027</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u53EF\u9009\u503C</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td>xml</td><td>\u5BFC\u5165\u7684 xml \u5B57\u7B26\u4E32</td><td>string</td><td>-</td><td>-</td></tr><tr><td>data</td><td>\u4E3A\u6BCF\u4E2A\u8282\u70B9\u6DFB\u52A0\u989C\u8272\u548C\u6587\u672C\u63D0\u793A</td><td>ViewerData[]</td><td>-</td><td>-</td></tr><tr><td>initOptions</td><td>\u521D\u59CB\u5316\u914D\u7F6E</td><td>ViewerOptions</td><td>-</td><td></td></tr></tbody></table><h2 id="type-definition" tabindex="-1">Type Definition <a class="header-anchor" href="#type-definition" aria-hidden="true">#</a></h2><div class="language-ts"><div class="highlight-lines"><br><br><br><br><br><br><br><br></div><pre><code><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">ViewerData</span> <span class="token punctuation">{</span>
  elementId<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
  colors<span class="token operator">?</span><span class="token operator">:</span> Colors<span class="token punctuation">;</span>
  tooltips<span class="token operator">?</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    html<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
